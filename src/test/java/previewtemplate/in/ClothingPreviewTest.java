...
public class ClothingPreviewTest extends BaseClass_Login{
	
	File dstFile,srcFile;
	Logger logger = Logger.getLogger(ClothingPreviewTest.class);
	String templateName="ClothingTemplate";
	public ClothingPreviewTest() throws IOException, InvalidFormatException {
		super();
	...
	private void previewTemplate(String template) throws InterruptedException, IOException {
		...
		ClothingTemplate b =new ClothingTemplate(driver);
		b.clickCategory();
		Thread.sleep(5000);
		b.clickPreview(1);
		Thread.sleep(10000);
