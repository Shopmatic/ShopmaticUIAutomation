...
public class SignUpWithBlankTemplateNeoEnabledAndSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateNeoEnabledAndSelfCollect() throws IOException, InvalidFormatException {
		super();
