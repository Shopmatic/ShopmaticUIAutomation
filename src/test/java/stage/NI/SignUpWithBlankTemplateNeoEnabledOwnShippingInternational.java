...
public class SignUpWithBlankTemplateNeoEnabledOwnShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateNeoEnabledOwnShippingInternational() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_stage() throws InterruptedException {
		...
		neoPage.clickSubmit();
		Thread.sleep(4000);pb.clickDashboard();
		Thread.sleep(1000);
		pb.selectSetUp();
		pb.clickShipping();
		Thread.sleep(5000);
