...
public class SignUpWithBlankTemplateOwnShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateOwnShippingInternational() throws IOException, InvalidFormatException {
		super();
