...
public class SignUpWithBlankTemplateNeoEnabledAndAramexShippingDomestic extends BaseClass{
	...
	public SignUpWithBlankTemplateNeoEnabledAndAramexShippingDomestic() throws IOException, InvalidFormatException {
		super();
