...
import BasePageOptions.Marketing.Seo;
...
public class addSeoTest extends BaseClass_Login{
	...
	public addSeoTest() throws IOException, InvalidFormatException {
		super();
	...
	public void addSeoHomePage() throws InterruptedException{
		pageBuilderPage = new PageBuilderPage(driver);
