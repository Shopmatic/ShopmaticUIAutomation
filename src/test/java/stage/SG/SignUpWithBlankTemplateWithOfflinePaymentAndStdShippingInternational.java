...
public class SignUpWithBlankTemplateWithOfflinePaymentAndStdShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndStdShippingInternational() throws IOException, InvalidFormatException {
		super();
