...
public class SignUpWithBlankTemplateWithOfflinePaymentAndSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndSelfCollect() throws IOException, InvalidFormatException {
		super();
