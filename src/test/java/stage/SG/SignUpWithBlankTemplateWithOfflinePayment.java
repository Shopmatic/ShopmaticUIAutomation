...
public class SignUpWithBlankTemplateWithOfflinePayment extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePayment() throws IOException, InvalidFormatException {
		super();
