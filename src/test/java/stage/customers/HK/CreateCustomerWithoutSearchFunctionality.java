...
public class CreateCustomerWithoutSearchFunctionality extends BaseClass_Login{
	...
	public CreateCustomerWithoutSearchFunctionality() throws IOException, InvalidFormatException {
		super();
