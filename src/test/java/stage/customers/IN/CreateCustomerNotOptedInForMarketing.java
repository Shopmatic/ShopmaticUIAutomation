...
public class CreateCustomerNotOptedInForMarketing extends BaseClass_Login{
	...
	public CreateCustomerNotOptedInForMarketing() throws IOException, InvalidFormatException {
		super();
	...
	public void createOrder() throws InterruptedException {
	    ...
	    Thread.sleep(2000);
	    productShippingDetails.clickSubscribeToMarketingEmails();
