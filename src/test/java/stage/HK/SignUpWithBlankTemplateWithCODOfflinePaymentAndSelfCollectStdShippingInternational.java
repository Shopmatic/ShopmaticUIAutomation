...
public class SignUpWithBlankTemplateWithCODOfflinePaymentAndSelfCollectStdShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODOfflinePaymentAndSelfCollectStdShippingInternational() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_stage() throws InterruptedException {
		...
		shippingOptionsPage.addSelfCollectDetails("dhjfejfg");
