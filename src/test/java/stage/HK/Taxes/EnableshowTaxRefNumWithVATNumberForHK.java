...
public class EnableshowTaxRefNumWithVATNumberForHK extends BaseClass{
	...
	public EnableshowTaxRefNumWithVATNumberForHK() throws IOException, InvalidFormatException {
		super();
