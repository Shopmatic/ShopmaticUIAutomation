...
public class SignUpWithBlankTemplateWithCitrusAndAramex extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusAndAramex() throws IOException, InvalidFormatException {
		super();
