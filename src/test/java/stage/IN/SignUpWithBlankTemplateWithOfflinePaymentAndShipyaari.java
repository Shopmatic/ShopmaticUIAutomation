...
public class SignUpWithBlankTemplateWithOfflinePaymentAndShipyaari extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndShipyaari() throws IOException, InvalidFormatException {
		super();
