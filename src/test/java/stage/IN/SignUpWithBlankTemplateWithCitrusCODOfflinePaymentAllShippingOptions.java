...
public class SignUpWithBlankTemplateWithCitrusCODOfflinePaymentAllShippingOptions extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusCODOfflinePaymentAllShippingOptions() throws IOException, InvalidFormatException {
		super();
