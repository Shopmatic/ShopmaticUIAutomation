...
public class SignUpWithBlankTemplateWithOfflinePaymentAndOwnShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndOwnShippingInternational() throws IOException, InvalidFormatException {
		super();
