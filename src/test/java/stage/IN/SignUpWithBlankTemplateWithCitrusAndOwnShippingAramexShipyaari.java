...
public class SignUpWithBlankTemplateWithCitrusAndOwnShippingAramexShipyaari extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusAndOwnShippingAramexShipyaari() throws IOException, InvalidFormatException {
		super();
