...
public class SignUpWithBlankTemplateWithOfflinePaymentAndAramexShipyaari extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndAramexShipyaari() throws IOException, InvalidFormatException {
		super();
