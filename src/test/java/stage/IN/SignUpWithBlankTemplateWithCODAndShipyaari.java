...
public class SignUpWithBlankTemplateWithCODAndShipyaari extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndShipyaari() throws IOException, InvalidFormatException {
		super();
