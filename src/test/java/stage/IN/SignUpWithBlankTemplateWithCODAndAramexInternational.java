...
public class SignUpWithBlankTemplateWithCODAndAramexInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndAramexInternational() throws IOException, InvalidFormatException {
		super();
