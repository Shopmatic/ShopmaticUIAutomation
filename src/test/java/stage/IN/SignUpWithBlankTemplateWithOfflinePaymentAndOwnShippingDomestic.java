...
public class SignUpWithBlankTemplateWithOfflinePaymentAndOwnShippingDomestic extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndOwnShippingDomestic() throws IOException, InvalidFormatException {
		super();
