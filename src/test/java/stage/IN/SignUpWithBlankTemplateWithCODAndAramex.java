...
public class SignUpWithBlankTemplateWithCODAndAramex extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndAramex() throws IOException, InvalidFormatException {
		super();
