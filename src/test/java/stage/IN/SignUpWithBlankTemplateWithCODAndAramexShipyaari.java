...
public class SignUpWithBlankTemplateWithCODAndAramexShipyaari extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndAramexShipyaari() throws IOException, InvalidFormatException {
		super();
