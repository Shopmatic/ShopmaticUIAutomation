...
public class SignUpWithBlankTemplateWithOfflinePaymentAndAramexInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndAramexInternational() throws IOException, InvalidFormatException {
		super();
