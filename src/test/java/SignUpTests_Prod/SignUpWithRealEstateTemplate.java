...
import TemplateCategories.RealEstateTemplate;

public class SignUpWithRealEstateTemplate extends BaseClass{
	...
	public SignUpWithRealEstateTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		RealEstateTemplate realEstateTemplate = new RealEstateTemplate(driver);
		realEstateTemplate.clickEditTemplate(1);		
