...
public class SignUpWithWeddingsAndEventsTemplate extends BaseClass{
	...
	public SignUpWithWeddingsAndEventsTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		WeddingsAndEventsTemplate weddingsAndEventsTemplate = new WeddingsAndEventsTemplate(driver);
		weddingsAndEventsTemplate.clickEditTemplate(1);		
