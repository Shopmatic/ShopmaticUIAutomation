...
import TemplateCategories.KitchenAndHousewareTemplate;

public class SignUpWithKitchenAndHousewareTemplate extends BaseClass{
	...
	public SignUpWithKitchenAndHousewareTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		KitchenAndHousewareTemplate kitchenAndHousewareTemplate = new KitchenAndHousewareTemplate(driver);
		kitchenAndHousewareTemplate.clickEditTemplate(1);		
		...
		AssertJUnit.assertEquals(driver.getCurrentUrl().toString(),""+(firstName+"store.myshopmatic.com/").toLowerCase());	
	}
