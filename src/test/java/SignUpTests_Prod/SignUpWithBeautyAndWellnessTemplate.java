...
public class SignUpWithBeautyAndWellnessTemplate extends BaseClass{
	...
	public SignUpWithBeautyAndWellnessTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		BeautyAndWellnessTemplate beautyAndWellnessTemplate = new BeautyAndWellnessTemplate(driver);
		beautyAndWellnessTemplate.clickEditTemplate(1);		
