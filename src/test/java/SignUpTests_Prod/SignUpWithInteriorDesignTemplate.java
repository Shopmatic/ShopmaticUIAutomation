...
import TemplateCategories.InteriorDesignTemplate;

public class SignUpWithInteriorDesignTemplate extends BaseClass{
	...
	public SignUpWithInteriorDesignTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		InteriorDesignTemplate interiorDesignTemplate = new InteriorDesignTemplate(driver);
		interiorDesignTemplate.clickEditTemplate(1);		
