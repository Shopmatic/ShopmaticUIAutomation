...
public class SignUpWithFashionAccessoriesTemplate extends BaseClass{
	...
	public SignUpWithFashionAccessoriesTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		FashionAccessoriesTemplate fashionAccessoriesTemplate = new FashionAccessoriesTemplate(driver);
		fashionAccessoriesTemplate.clickEditTemplate(1);		
