...
import TemplateCategories.DecorAndFurnitureTemplate;

public class SignUpWithDecoreAndFurnitureTemplate extends BaseClass{
	...
	public SignUpWithDecoreAndFurnitureTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		DecorAndFurnitureTemplate decoreAndFurnitureTemplate = new DecorAndFurnitureTemplate(driver);
		decoreAndFurnitureTemplate.clickEditTemplate(1);		
