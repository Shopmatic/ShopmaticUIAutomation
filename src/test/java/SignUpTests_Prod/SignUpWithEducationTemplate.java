...
public class SignUpWithEducationTemplate extends BaseClass{
	...
	public SignUpWithEducationTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		EducationTemplate educationTemplate = new EducationTemplate(driver);
		educationTemplate.clickEditTemplate(1);		
