...
import TemplateCategories.HealthServicesTemplate;

public class SignUpWithHealthServicesTemplate extends BaseClass{
	...
	public SignUpWithHealthServicesTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		HealthServicesTemplate healthServicesTemplate = new HealthServicesTemplate(driver);
		healthServicesTemplate.clickEditTemplate(1);		
