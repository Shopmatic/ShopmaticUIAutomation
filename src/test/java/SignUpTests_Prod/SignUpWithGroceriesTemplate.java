...
import TemplateCategories.GroceriesTemplate;

public class SignUpWithGroceriesTemplate extends BaseClass{
	...
	public SignUpWithGroceriesTemplate() throws IOException, InvalidFormatException {
		super();
	...
	public void testMethod_goshopmatic_prod() throws InterruptedException {
		...
		GroceriesTemplate groceriesTemplate = new GroceriesTemplate(driver);
		groceriesTemplate.clickEditTemplate(1);		
