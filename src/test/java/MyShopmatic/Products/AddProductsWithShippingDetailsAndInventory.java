...
public class AddProductsWithShippingDetailsAndInventory extends BaseClass_Login{
	...
	public AddProductsWithShippingDetailsAndInventory() throws IOException, InvalidFormatException {
		super();
	...
	public void testAddProduct() throws InterruptedException {
		...
		products.addInventorySKU("inventory-1");
		products.addUpc("upc-1");
