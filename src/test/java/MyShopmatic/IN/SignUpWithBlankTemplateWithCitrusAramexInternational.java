...
public class SignUpWithBlankTemplateWithCitrusAramexInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusAramexInternational() throws IOException, InvalidFormatException {
		super();
