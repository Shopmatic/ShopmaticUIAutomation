...
public class SignUpWithBlankTemplateWithCitrusCODOfflinePayment extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusCODOfflinePayment() throws IOException, InvalidFormatException {
		super();
