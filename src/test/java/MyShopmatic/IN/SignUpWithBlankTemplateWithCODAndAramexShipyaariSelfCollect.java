...
public class SignUpWithBlankTemplateWithCODAndAramexShipyaariSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndAramexShipyaariSelfCollect() throws IOException, InvalidFormatException {
		super();
