...
public class SignUpWithBlankTemplateWithOfflinePaymentAndAramexShipyaariSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateWithOfflinePaymentAndAramexShipyaariSelfCollect() throws IOException, InvalidFormatException {
		super();
