...
public class SignUpWithBlankTemplateWithCitrusAndSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCitrusAndSelfCollect() throws IOException, InvalidFormatException {
		super();
