...
public class SignUpWithBlankTemplateWithCODAndSelfCollect extends BaseClass{
	...
	public SignUpWithBlankTemplateWithCODAndSelfCollect() throws IOException, InvalidFormatException {
		super();
