...
public class EnableTaxesWithoutTaxRateForNI extends BaseClass{
	...
	public EnableTaxesWithoutTaxRateForNI() throws IOException, InvalidFormatException {
		super();
	...
	public void enableVAT() throws InterruptedException {
		...
		Thread.sleep(2000);
		Assert.assertTrue(tax.getMessage().contains("Vat is not a number"), "VAT rate cannot be null.It should be b/w 0-100% range");
