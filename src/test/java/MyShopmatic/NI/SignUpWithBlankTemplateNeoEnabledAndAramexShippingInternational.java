...
public class SignUpWithBlankTemplateNeoEnabledAndAramexShippingInternational extends BaseClass{
	...
	public SignUpWithBlankTemplateNeoEnabledAndAramexShippingInternational() throws IOException, InvalidFormatException {
		super();
